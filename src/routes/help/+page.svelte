...
>
	...
	<div class="flex flex-col items-center justify-center text-center w-9/12 space-y-4">
		...
		<p class="p text-lg">Use your deck to build powerful hands, take advantage from the abilities of your characters and the weapons you collect through your journey and try to destroy your ennemies.</p>
    ...
    <div class="flex flex-col items-center justify-center">
		<ul class="list-disc">
			...
			<li>If your hand is more powerful than the hand of your ennemy, the difference is dealt to their health</li>
